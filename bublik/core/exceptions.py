...
def custom_exception_handler(exc, context):
    ...
    if response is None:
        ...
        updated_response_data['details'] = normalize_error_details(msg)
        return Response(updated_response_data, status=500)

    updated_response_data['details'] = normalize_error_details(response.data)
...
class ImportrunsError(BublikServerError):
    pass
