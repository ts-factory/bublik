...
class AiChatThreadListSerializer(ModelSerializer):
...
class AiChatThreadDetailSerializer(ModelSerializer):
    ...
    def get_context_usage(self, obj) -> dict | None:
        ...
        return {
            ...
            # The provider's own token breakdown, for diagnosing gateways whose
            # reported usage does not match what was actually sent.
