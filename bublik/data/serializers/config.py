...
from bublik.data.models import Config, ConfigTypes, GlobalConfigNames, Meta, User
...
class ConfigSerializer(ModelSerializer):
    ...
    def create(self, config_data):
        ...
        if config_data['project'] and not isinstance(config_data['project'], Meta):
            config_data['project'] = Meta.projects.get(id=config_data['project'])
